        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    KaggleUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtractedSkills = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    AIAnalysis = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Conference = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    GoogleScholarUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sentiment = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RankingReason = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectRankings_JobDescriptions_JobDescriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelevanceScore = table.Column<int>(type: "int", nullable: false),
                    HighlightReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AISkillHighlights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AISkillHighlights_JobDescriptions_JobDescriptionId",
                        column: x => x.JobDescriptionId,
                        principalTable: "JobDescriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AISkillHighlights_Skills_SkillId",
                        column: x => x.SkillId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AISkillHighlights_JobDescriptionId",
                table: "AISkillHighlights",
                column: "JobDescriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_AISkillHighlights_SkillId",
                table: "AISkillHighlights",
                column: "SkillId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectRankings_JobDescriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisitorFeedbacks_SubmittedDate",
                table: "VisitorFeedbacks",
